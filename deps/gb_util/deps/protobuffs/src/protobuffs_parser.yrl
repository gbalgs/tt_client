Nonterminals
g_protobuffs g_header g_message g_rpcs g_rpc g_element g_elements g_var g_value g_default g_comment.
...
g_message -> g_var g_var '[' g_var '=' g_value ',' g_var '=' g_var ']' '{' g_elements '}'			: {'$1', safe_string('$2'), '$6', safe_string('$10'), '$13'}.
g_message -> g_var g_var '[' g_var '=' g_value ',' g_var '=' g_var ']' '{' g_rpcs '}'				: {'$1', safe_string('$2'), '$6', safe_string('$10'), '$13'}.
g_message -> g_var g_var '[' g_var '=' g_value ',' g_var '=' g_var ']' '{' '}'					: {'$1', safe_string('$2'), '$6', safe_string('$10'), []}.
g_message -> g_var g_var '[' g_var '=' g_value ']' '{' g_elements '}'			: {'$1', safe_string('$2'), '$6', "role", '$9'}.
g_message -> g_var g_var '[' g_var '=' g_value ']' '{' g_rpcs '}'				: {'$1', safe_string('$2'), '$6', "role", '$9'}.
g_message -> g_var g_var '[' g_var '=' g_value ']' '{' '}'					: {'$1', safe_string('$2'), '$6', "role", []}.
